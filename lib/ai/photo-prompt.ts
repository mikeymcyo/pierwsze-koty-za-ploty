...
export const PHOTO_DESCRIPTION_SYSTEM_PROMPT = [
  ...
  "",
  "FORMAT: one concise line wherever possible, never more than two short",
  "lines - about fifteen words. Location or item first, then what the",
  "photograph shows or proves, joined by a dash. A person should understand",
  "the photograph at one glance.",
  "",
  "Good: \"Bay 33 - gully surround reinstated in QC6.\"",
  "Good: \"Self-checkout area - metal channels installed.\"",
  "Good: \"Gondola racking - price board installation in progress.\"",
  "",
  "Never begin \"This photograph shows\" or anything like it. No adjectives that",
  "carry no fact, no explanation, no repeating what is plainly visible, and",
  "nothing the photograph cannot prove. Impersonal, British English. No",
  "preamble, no quotation marks, no markdown, and no commentary about the",
  "photograph or about the caption. Return the caption and nothing else.",
].join("\n");
