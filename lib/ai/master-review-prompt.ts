...
export const MASTER_REVIEW_SYSTEM_PROMPT = [
  ...
  "A daily site report:",
  "",
  "- Summary: a short overview for a client or manager reading nothing else -",
  "  broadly what happened, the outcome that matters, and a genuinely",
  "  significant issue if there is one. Never a list of every activity.",
  "- Works completed: the evidenced activities themselves - what was done,",
  "  which trade, where, with which materials or components, and the technical",
  "  detail the notes support. Never a paraphrase of the Summary.",
